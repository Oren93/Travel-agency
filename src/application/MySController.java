...
class sController {
    ...
    private ObservableList<TourDate> tourDates = null;
	...
	ObservableList<Package> search(Parameters parameters) {
		...
		int cheapPackagePrice = cheapFlightsPrice + cheapRoom.getPricePerNight()*(int)voyageLength + toursPrice;
		int bestPackagePrice = shortFlightsPrice + bestRoom.getPricePerNight()*(int)voyageLength + toursPrice;
	...
	public boolean bookPackage(TourPackage p, Passenger pass, Parameters para){
